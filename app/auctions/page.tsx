...
function UrgencyPill({ endAt, now }: { endAt: Date; now: Date }) {
  ...
  return (
    <span
      className={`text-xs px-2 py-0.5 rounded-full shrink-0 font-bold whitespace-nowrap inline-flex items-center gap-1 ${
        u.tone === "urgent"
            ...
            {auctions.map((auction) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Stats — item count only; auction totals are admin-only. */}
