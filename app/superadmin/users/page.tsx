      ...
      <header className="border-b border-[#e3d6bf]/60 px-4 sm:px-8 py-4 flex items-center justify-between gap-4">
        ...
        <form onSubmit={handleSearch} className="flex gap-2">
          <input
            ...
            className="bg-[#efe3d0] border border-[#cdbda3] rounded-xl px-4 py-2 text-sm text-[#241a12] placeholder-[#b3a085] focus:outline-none focus:border-[#6c4d39] w-56"
          />
          <button type="submit" className="bg-[#07878d] hover:bg-[#563e2c] text-white text-sm font-semibold px-4 py-2 rounded-xl transition-colors">
            Search
          </button>
          {query && (
                  ...
                  <tr key={u.clerkUserId} className="hover:bg-[#efe3d0]/30 transition-colors">
                    <td className="px-5 py-3">
                      <Link
                        ...
                        className="hover:text-[#6c4d39] transition-colors"
                      >
