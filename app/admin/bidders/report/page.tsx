...
export default function BidderReportPage() {
    ...
    return (
      <>
        <header className="border-b border-[#e3d6bf] px-5 sm:px-8 py-4">
          <h1 className="text-2xl sm:text-3xl font-semibold">Bidder Report</h1>
        </header>
  ...
  return (
    <>
      <header className="border-b border-[#e3d6bf] px-5 sm:px-8 py-4 flex items-center justify-between gap-3">
        <h1 className="text-2xl sm:text-3xl font-semibold">Bidder Report</h1>
        <Link href="/admin/bidders" className="text-sm font-semibold text-[#6c4d39] hover:underline whitespace-nowrap">
          Manage bidders →
        </Link>
      </header>
      ...
      <div className="px-4 sm:px-8 py-5 space-y-6 max-w-3xl mx-auto w-full pb-20">
        ...
        <div className="space-y-3">
          ...
          <div className="text-xs text-[#8a7559] px-1">{filtered.length} bidder{filtered.length !== 1 ? "s" : ""}</div>
        </div>
