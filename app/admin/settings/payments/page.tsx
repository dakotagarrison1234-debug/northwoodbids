    ...
    <div className="max-w-xl">
      ...
      <div className="bg-white border border-[#e3d6bf] rounded-2xl p-6 mb-5">
        ...
        <div className="flex items-center mb-2">
          ...
          <span className="text-[#241a12] font-semibold">Active — accepting payments</span>
        </div>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-block mt-4 bg-[#efe3d0] hover:bg-[#e7dcc6] border border-[#cdbda3] text-[#241a12] text-sm font-semibold px-5 py-2.5 rounded-xl transition-colors"
        >
      ...
      <div className="bg-white border border-[#e3d6bf] rounded-2xl p-6 mb-5">
        ...
        {loading || !org ? (
          <p className="text-sm text-[#8a7559]">Loading…</p>
        ) : (
      ...
      <div className="bg-white border border-[#e3d6bf] rounded-2xl p-6">
        ...
        <ul className="text-sm text-[#6f5b46] space-y-2 list-disc pl-5">
