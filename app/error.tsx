  ...
  return (
    <main className="min-h-screen bg-[#f1e7d5] text-[#241a12] flex items-center justify-center px-5">
      <div className="text-center max-w-sm w-full">
        <div className="text-[#6c4d39] font-extrabold text-xl mb-6">Northwood Bids</div>
        ...
        <div className="flex flex-col gap-2.5">
          <button
            onClick={reset}
            className="w-full bg-[#6c4d39] hover:bg-[#563e2c] text-white font-semibold py-3 rounded-xl transition-colors"
          >
            Try again
          </button>
