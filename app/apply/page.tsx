...
// cannot self-apply to host. This route redirects home; the card below is what
      ...
      <div className="w-full max-w-md">
        <div className="bg-white border border-[#e3d6bf] rounded-3xl shadow-[0_24px_60px_-24px_rgba(108,77,57,0.5)] overflow-hidden">
          <div className="relative px-6 pt-7 pb-6 text-center text-white" style={{ background: "linear-gradient(140deg,#6c4d39,#8a5a2f)" }}>
            ...
            <h1 className="font-display text-[1.6rem] leading-tight font-black">One house, one block</h1>
            <p className="text-white/85 text-sm mt-1">Northwood Bids runs its own auctions. There&apos;s nothing to apply for.</p>
          </div>
          <div className="px-6 py-6 text-center">
            <p className="text-sm text-[#6f5b46] leading-relaxed">
              Taking you to the lots now. If you meant to bid, that&apos;s where the action is.
            </p>
