 ...
 * what's live, espresso for what's on deck — plus a tiny eyebrow line, a big
 * display title and a one-line tagline. Pure markup, safe in client or server trees.
 */

type Variant = "hot" | "live" | "upcoming";
...
export default function SectionHeader({
  ...
  return (
    <div className={`relative rounded-2xl bg-gradient-to-r ${t.tint} pl-5 pr-3 sm:pr-4 py-3.5 sm:py-4 mb-6 flex items-center justify-between gap-3`}>
      ...
      <div className="min-w-0 pl-1">
        ...
        <h2 className="font-display text-3xl sm:text-4xl font-black leading-[0.95] tracking-tight text-[#241a12] mt-1">
          {title}
        </h2>
