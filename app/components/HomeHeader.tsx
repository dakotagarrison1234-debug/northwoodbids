...
export default function HomeHeader() {
  ...
  return (
    <header className="bar-safe-top safe-x border-b border-[#e3d6bf] px-6 sm:px-8 pb-4 flex items-center justify-between gap-3 bg-white/95 backdrop-blur-md sticky top-0 z-40 shadow-sm">
