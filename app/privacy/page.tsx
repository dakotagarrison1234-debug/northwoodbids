  ...
  return (
    <div className="min-h-screen bg-[#f1e7d5] text-[#241a12]">
      <main className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-extrabold text-[#241a12] mb-2">Privacy Policy</h1>
        <p className="text-[#8a7559] text-sm mb-10">Last updated: June 15, 2026</p>

        <div className="space-y-8 text-[#4a3a2b] leading-relaxed">

          <section>
            <h2 className="text-lg font-bold text-[#241a12] mb-3">1. Introduction</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#241a12] mb-3">2. Information We Collect</h2>
            <p className="mb-3">We collect the following categories of information:</p>

            <h3 className="font-semibold text-[#241a12] mb-2">Information you provide directly</h3>
            ...
            <h3 className="font-semibold text-[#241a12] mb-2">Information collected automatically</h3>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#241a12] mb-3">3. How We Use Your Information</h2>
            <ul className="list-disc pl-5 space-y-1.5">
          ...
          <section>
            ...
            <h3 className="font-semibold text-[#241a12] mt-4 mb-2">For legal reasons</h3>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#241a12] mb-3">5. Data Retention</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#241a12] mb-3">6. Your Rights and Choices</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#241a12] mb-3">7. Cookies and Tracking</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#241a12] mb-3">8. Security</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#241a12] mb-3">9. Children's Privacy</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#241a12] mb-3">10. Changes to This Policy</h2>
